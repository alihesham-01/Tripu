...
class HotelsSaved extends StatefulWidget {
  const HotelsSaved ({super.key});

  @override
  State<HotelsSaved> createState() => _ChooseAlexState();
}

class _ChooseAlexState extends State<HotelsSaved> {
  bool isTapped = false;
  @override
