...
class CitesSaved extends StatefulWidget {
  const CitesSaved({super.key});

  @override
  State<CitesSaved> createState() => _ChooseAlexState();
}

class _ChooseAlexState extends State<CitesSaved> {
  bool isTapped = false;
  @override
