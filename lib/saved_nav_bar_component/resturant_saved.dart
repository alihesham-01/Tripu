...
class ResturantsSaved extends StatefulWidget {
  const ResturantsSaved({super.key});

  @override
  State<ResturantsSaved> createState() => _ChooseAlexState();
}

class _ChooseAlexState extends State<ResturantsSaved> {
  bool isTapped = false;
  @override
