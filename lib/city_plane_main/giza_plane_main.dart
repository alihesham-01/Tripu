...
class GizaPlaneMain extends StatefulWidget {
  const GizaPlaneMain({super.key});

  @override
  State<GizaPlaneMain> createState() => _GizaPlaneMainState();
}

class _GizaPlaneMainState extends State<GizaPlaneMain> {
  @override
