...
class CairoPlaneMain extends StatefulWidget {
  const CairoPlaneMain({super.key});

  @override
  State<CairoPlaneMain> createState() => _CairoPlaneMainState();
}

class _CairoPlaneMainState extends State<CairoPlaneMain> {
  @override
