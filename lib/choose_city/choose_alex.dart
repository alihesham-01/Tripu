...
class ChooseAlex extends StatefulWidget {
  const ChooseAlex({super.key});

  @override
  State<ChooseAlex> createState() => _ChooseAlexState();
}

class _ChooseAlexState extends State<ChooseAlex> {
  bool isTapped = false;
  @override
