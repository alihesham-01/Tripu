...
class ChooseGiza extends StatefulWidget {
  const ChooseGiza({super.key});

  @override
  State<ChooseGiza> createState() => _ChooseGizaState();
}

class _ChooseGizaState extends State<ChooseGiza> {
  bool isTapped = false;
  @override
