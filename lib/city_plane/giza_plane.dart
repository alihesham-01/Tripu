...
import '../city_plane_main/giza_plane_main.dart';

class GizaPlane extends StatelessWidget {
  const GizaPlane({super.key});
  ...
  Widget build(BuildContext context) {
    return InkWell(
      onTap: () {
        Navigator.push(
            context, MaterialPageRoute(builder: (context) => GizaPlaneMain()));
      },
      child: Container(
        width: 175,
        height: 197,
