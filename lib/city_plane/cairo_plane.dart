...
import 'package:tripu/city_plane_main/cairo_plane_main.dart';



class CairoPlane extends StatelessWidget {
  const CairoPlane({super.key});
  ...
  Widget build(BuildContext context) {
    return InkWell(
      ...
      Navigator.push(context,
          MaterialPageRoute(builder: (context) => CairoPlaneMain()));},
