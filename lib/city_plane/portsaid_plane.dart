...
import '../city_plane_main/portsaid_plane_main.dart';


class PortSaidPlane extends StatelessWidget {
  const PortSaidPlane({super.key});
    ...
    return InkWell(
      onTap: () {
        Navigator.push(context,
            MaterialPageRoute(builder: (context) => PortsaidPlaneMain()));
      },
      child: Container(
        width: 175,
        height: 197,
                ...
                Padding(
                  ...
                  child: Row(children: [
                    ...
                    Padding(
                      ...
                      child: Icon(
                          Icons.star_rate, size: 15, color: Colors.yellow),
                    ),
                  ]),
                )
              ],
